...
async def test_unread_returns_channels():
    from akashic.tools.slack_web import _unread_async
...
async def test_unread_needs_auth_when_login_page():
    ...
    assert result == [{"needs_auth": True, "run": "akashic auth slack"}]


@pytest.mark.asyncio
async def test_search_returns_results():
    from akashic.tools.slack_web import _search_async
